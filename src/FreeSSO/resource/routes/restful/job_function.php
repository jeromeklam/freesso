...
/**
 * Routes for JobFunction
 *
 * @author jeromeklam
 */
$routes_job_function = [
    'free_s_s_o.job_function.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/JobFunction',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::JobFunction',
        FFCSTRT::ROUTE_URL        => '/v1/sso/job_function/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::JobFunction',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeSSO::Model::JobFunction',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_s_s_o.job_function.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/JobFunction',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::JobFunction',
        FFCSTRT::ROUTE_URL        => '/v1/sso/job_function',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::JobFunction',
    ...
    'free_s_s_o.job_function.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/JobFunction',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::JobFunction',
        FFCSTRT::ROUTE_URL        => '/v1/sso/job_function/:fct_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::JobFunction',
    ...
    'free_s_s_o.job_function.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/JobFunction',
    ...
    'free_s_s_o.job_function.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/JobFunction',
    ...
    'free_s_s_o.job_function.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/JobFunction',

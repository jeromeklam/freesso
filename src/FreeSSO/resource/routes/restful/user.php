...
$routes_user = [
    'free_s_s_o.user.autocomplete' => [
        ...
        FFCSTRT::ROUTE_URL        => '/v1/sso/user/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::User',
    ...
    'free_s_s_o.user.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/User',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::User',
        FFCSTRT::ROUTE_URL        => '/v1/sso/user/:user_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::User',
        FFCSTRT::ROUTE_FUNCTION   => 'getOne',
        FFCSTRT::ROUTE_AUTH       => FFCSTRT::AUTH_IN,
        FFCSTRT::ROUTE_MIDDLEWARE => [],
        FFCSTRT::ROUTE_INCLUDE    => [
            FFCSTRT::ROUTE_INCLUDE_DEFAULT => ['brokers', 'brokers.broker', 'groups', 'groups.group', 'lang']
        ],
        FFCSTRT::ROUTE_SCOPE      => ['ROOT'],
        FFCSTRT::ROUTE_PARAMETERS => [
            'user_id' => [

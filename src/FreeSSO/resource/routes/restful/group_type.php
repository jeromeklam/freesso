...
/**
 * Routes for GroupType
 *
 * @author jeromeklam
 */
$routes_group_type = [
    'free_s_s_o.group_type.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/GroupType',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::GroupType',
        FFCSTRT::ROUTE_URL        => '/v1/sso/group_type/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::GroupType',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeSSO::Model::GroupType',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_s_s_o.group_type.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/GroupType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::GroupType',
        FFCSTRT::ROUTE_URL        => '/v1/sso/group_type',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::GroupType',
    ...
    'free_s_s_o.group_type.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/GroupType',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::GroupType',
        FFCSTRT::ROUTE_URL        => '/v1/sso/group_type/:grpt_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::GroupType',
    ...
    'free_s_s_o.group_type.createone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/GroupType',
    ...
    'free_s_s_o.group_type.updateone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/GroupType',
    ...
    'free_s_s_o.group_type.removeone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/GroupType',

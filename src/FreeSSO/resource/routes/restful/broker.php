 ...
 */
$routes_broker = [
    'free_s_s_o.broker.autocomplete' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/Broker',
        FFCSTRT::ROUTE_COMMENT    => 'Autocomplete.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::Broker',
        FFCSTRT::ROUTE_URL        => '/v1/sso/broker/autocomplete/:search',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::Broker',
        ...
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
                ...
                FFCSTRT::ROUTE_RESULTS_MODEL   => 'FreeSSO::Model::Broker',
                FFCSTRT::ROUTE_RESULTS_COMMENT => 'Réponse ok',
            ],
        ]
    ],
    'free_s_s_o.broker.getall' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/Broker',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne une liste filtrée, triée et paginée.',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::Broker',
        FFCSTRT::ROUTE_URL        => '/v1/sso/broker',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::Broker',
        FFCSTRT::ROUTE_FUNCTION   => 'getAll',
        FFCSTRT::ROUTE_AUTH       => FFCSTRT::AUTH_IN,
        FFCSTRT::ROUTE_MIDDLEWARE => [],
        FFCSTRT::ROUTE_INCLUDE    => [
            FFCSTRT::ROUTE_INCLUDE_DEFAULT => ['group', 'domain']
        ],
        FFCSTRT::ROUTE_SCOPE      => ['ROOT'],
        FFCSTRT::ROUTE_RESULTS    => [
            '200' => [
    ...
    'free_s_s_o.broker.getone' => [
        FFCSTRT::ROUTE_COLLECTION => 'FreeSSO/Sso/Broker',
        FFCSTRT::ROUTE_COMMENT    => 'Retourne un objet selon son identifiant',
        FFCSTRT::ROUTE_METHOD     => FFCSTRT::METHOD_GET,
        FFCSTRT::ROUTE_MODEL      => 'FreeSSO::Model::Broker',
        FFCSTRT::ROUTE_URL        => '/v1/sso/broker/:brk_id',
        FFCSTRT::ROUTE_CONTROLLER => 'FreeSSO::Controller::Broker',
